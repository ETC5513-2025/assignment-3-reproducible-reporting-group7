...
format:
  pdf:
    ...
    include-in-header: before-title.tex
...
This report used educational data sourced from the UK Office for National Statistics [@english_education_2024], and town coordinates were obtained using the `tidygeocoder` package [@tidygeocoder_coords].
...
- `tidygeocoder` [@tidygeocoder_coords]
- `viridis` [@viridis]
- `R` [@R]
